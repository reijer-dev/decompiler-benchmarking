...
.Lfunc_end23:
	...
	.p2align	2                               # -- Begin function FF_function_360
.LCPI24_0:
	.long	0x3f000000                      # float 0.5
	.text
	.globl	FF_function_360
	.p2align	4, 0x90
...
.Lfunc_end25:
	...
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
	.p2align	2                               # -- Begin function FF_function_362
.LCPI26_0:
	.long	0x3f000000                      # float 0.5
	.text
	.globl	FF_function_362
	.p2align	4, 0x90
...
.Lfunc_end28:
	...
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
	.p2align	2                               # -- Begin function FF_function_357
.LCPI29_0:
	.long	0x3f000000                      # float 0.5
	.text
	.globl	FF_function_357
	.p2align	4, 0x90
...
.Lfunc_end31:
	...
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
	.p2align	2                               # -- Begin function FF_function_369
.LCPI32_0:
	.long	0x3f000000                      # float 0.5
	.text
	.globl	FF_function_369
	.p2align	4, 0x90
...
# %bb.0:
	...
	movb	$0, %al
	callq	printf@PLT
	callq	FF_function_371
	callq	FF_function_372
	movss	%xmm0, -8(%rbp)
...
# %bb.0:
	...
	movb	$0, %al
	callq	printf@PLT
	callq	FF_function_368
	movss	%xmm0, -16(%rbp)
	callq	FF_function_370
	movss	%xmm0, -8(%rbp)
...
# %bb.0:
	...
	movb	$0, %al
	callq	printf@PLT
	callq	FF_function_365
	movzbl	%al, %edi
	callq	FF_function_357
	callq	FF_function_367
	movss	%xmm0, -8(%rbp)
...
.Lfunc_end39:
	...
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
	.p2align	2                               # -- Begin function FF_function_374
.LCPI40_0:
	.long	0x3f000000                      # float 0.5
	.text
	.globl	FF_function_374
	.p2align	4, 0x90
...
.Lfunc_end41:
	...
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
	.p2align	2                               # -- Begin function FF_function_378
.LCPI42_0:
	.long	0x3f000000                      # float 0.5
	.text
	.globl	FF_function_378
	.p2align	4, 0x90
...
# %bb.0:
	...
	movb	$0, %al
	callq	printf@PLT
	callq	FF_function_377
	movw	%ax, -8(%rbp)
	callq	FF_function_378
	movw	%ax, -2(%rbp)
...
# %bb.0:
	...
	movb	$0, %al
	callq	printf@PLT
	callq	FF_function_374
	callq	FF_function_376
	movw	%ax, -2(%rbp)
...
.Lfunc_end46:
	...
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
	.p2align	2                               # -- Begin function FF_function_382
.LCPI47_0:
	.long	0x3f000000                      # float 0.5
	.text
	.globl	FF_function_382
	.p2align	4, 0x90
...
.Lfunc_end49:
	...
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
	.p2align	2                               # -- Begin function FF_function_379
.LCPI50_0:
	.long	0x3f000000                      # float 0.5
	.text
	.globl	FF_function_379
	.p2align	4, 0x90
...
# %bb.0:
	...
	xorl	%edi, %edi
	xorl	%esi, %esi
	callq	FF_function_382
	movb	%al, %bl
	xorl	%edi, %edi
	callq	FF_function_383
...
# %bb.0:
	...
	movb	$0, %al
	callq	printf@PLT
	callq	FF_function_373
	movw	%ax, %bx
	xorl	%edi, %edi
	xorl	%esi, %esi
	xorl	%edx, %edx
	callq	FF_function_379
	movswl	%bx, %edi
	xorl	%esi, %esi
	xorl	%edx, %edx
	xorl	%ecx, %ecx
...
# %bb.0:
	...
	movq	%rax, -32(%rbp)
	movq	%rdx, -24(%rbp)
	movups	.L__const.FF_function_352.FF_x(%rip), %xmm0
	movaps	%xmm0, -16(%rbp)
	movl	$.L.str.97, %edi
	xorl	%eax, %eax
	callq	printf@PLT
...
# %bb.0:
	...
	callq	printf@PLT
	xorps	%xmm0, %xmm0
	callq	FF_function_351
	movups	.L__const.FF_function_350.FF_x(%rip), %xmm0
	movaps	%xmm0, -32(%rbp)
	movl	$.L.str.101, %edi
	xorl	%eax, %eax
	callq	printf@PLT
...
# %bb.0:
	...
	xorl	%eax, %eax
	callq	FF_function_349
	movups	.L__const.FF_function_347.FF_x(%rip), %xmm0
	movaps	%xmm0, -48(%rbp)
	movl	$.L.str.103, %edi
	xorl	%eax, %eax
	callq	printf@PLT
...
# %bb.0:
	...
	xorl	%edi, %edi
	xorl	%esi, %esi
	callq	FF_function_343
	movups	.L__const.FF_function_342.FF_x(%rip), %xmm0
	movaps	%xmm0, -32(%rbp)
	movl	$.L.str.108, %edi
	xorl	%eax, %eax
	callq	printf@PLT
...
# %bb.0:
	...
	xorl	%eax, %eax
	callq	FF_function_341
	movups	.L__const.FF_function_339.FF_x(%rip), %xmm0
	movaps	%xmm0, -32(%rbp)
	movl	$.L.str.110, %edi
	xorl	%eax, %eax
	callq	printf@PLT
...
# %bb.0:
	...
	xorl	%edi, %edi
	xorl	%esi, %esi
	callq	FF_function_338
	movq	%rax, %rdi
	xorl	%esi, %esi
	xorl	%edx, %edx
	xorl	%eax, %eax
	callq	FF_function_337
	movups	.L__const.FF_function_335.FF_x(%rip), %xmm0
	movaps	%xmm0, -32(%rbp)
	movl	$.L.str.114, %edi
	xorl	%eax, %eax
	callq	printf@PLT
...
# %bb.0:
	...
	xorl	%edi, %edi
	xorps	%xmm0, %xmm0
	callq	FF_function_328
	movq	%rax, -48(%rbp)
	movq	%rdx, -40(%rbp)
	movups	.L__const.FF_function_327.FF_x(%rip), %xmm0
	movaps	%xmm0, -32(%rbp)
	movl	$.L.str.121, %edi
	xorl	%eax, %eax
	callq	printf@PLT
...
# %bb.0:
	...
	callq	printf@PLT
	xorl	%edi, %edi
	callq	FF_function_324
	movq	%rax, -48(%rbp)
	movq	%rdx, -40(%rbp)
	movups	.L__const.FF_function_323.FF_x(%rip), %xmm0
	movaps	%xmm0, -32(%rbp)
	movl	$.L.str.128, %edi
	xorl	%eax, %eax
	callq	printf@PLT
...
# %bb.0:
	...
	movq	%rax, -64(%rbp)
	movq	%rdx, -56(%rbp)
	movups	.L__const.FF_function_320.FF_x(%rip), %xmm0
	movaps	%xmm0, -48(%rbp)
	movl	$.L.str.130, %edi
	xorl	%eax, %eax
	callq	printf@PLT
...
.Lfunc_end70:
	...
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
	.p2align	2                               # -- Begin function FF_function_317
.LCPI71_0:
	.long	0x3f000000                      # float 0.5
	.text
	.globl	FF_function_317
	.p2align	4, 0x90
...
.LBB71_2:
	...
	movq	%rax, -72(%rbp)
	movq	%rdx, -64(%rbp)
	movq	.L__const.FF_function_317.FF_x, %rax
	movq	%rax, -40(%rbp)
	movq	.L__const.FF_function_317.FF_x+8, %rax
	movq	%rax, -32(%rbp)
...
.Lfunc_end73:
	...
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
	.p2align	2                               # -- Begin function CF_function_387
.LCPI74_0:
	.long	0x3f000000                      # float 0.5
	.text
	.globl	CF_function_387
	.p2align	4, 0x90
...
.Lfunc_end74:
	...
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
	.p2align	2                               # -- Begin function FF_function_388
.LCPI75_0:
	.long	0x3f000000                      # float 0.5
	.text
	.globl	FF_function_388
	.p2align	4, 0x90
...
.Lfunc_end77:
	...
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
	.p2align	2                               # -- Begin function CF_function_390
.LCPI78_0:
	.long	0x3f000000                      # float 0.5
	.text
	.globl	CF_function_390
	.p2align	4, 0x90
...
.Lfunc_end78:
	...
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
	.p2align	2                               # -- Begin function CF_function_392
.LCPI79_0:
	.long	0x3f000000                      # float 0.5
.LCPI79_1:
	.long	0x45225c29                      # float 2597.76001
...
# %bb.41:                               #   in Loop: Header=BB79_40 Depth=2
	movss	-12(%rbp), %xmm0                # xmm0 = mem[0],zero,zero,zero
	cvtss2sd	%xmm0, %xmm0
	movsd	.LCPI79_2(%rip), %xmm1          # xmm1 = mem[0],zero
	addsd	%xmm1, %xmm0
	cvtsd2ss	%xmm0, %xmm0
	movss	%xmm0, -12(%rbp)
# %bb.42:                               #   in Loop: Header=BB79_40 Depth=2
	movss	-12(%rbp), %xmm0                # xmm0 = mem[0],zero,zero,zero
	cvtss2sd	%xmm0, %xmm0
	movsd	.LCPI79_3(%rip), %xmm1          # xmm1 = mem[0],zero
	ucomisd	%xmm0, %xmm1
	jae	.LBB79_40
# %bb.43:                               #   in Loop: Header=BB79_1 Depth=1
	jmp	.LBB79_44
...
.LCPI80_0:
	.long	0x3f000000                      # float 0.5
.LCPI80_4:
	.long	0x450f659a                      # float 2294.3501
.LCPI80_7:
	.long	0xbf800000                      # float -1
	.section	.rodata.cst8,"aM",@progbits,8
	.p2align	3
.LCPI80_1:
	.quad	0x40a6040000000000              # double 2818
.LCPI80_2:
	.quad	0x40a57a0000000000              # double 2749
.LCPI80_3:
	.quad	0x40a4fa0000000000              # double 2685
.LCPI80_5:
	.quad	0x40a1cc0000000000              # double 2278
.LCPI80_6:
	.quad	0x40a28a0000000000              # double 2373
	.text
	.globl	main
	.p2align	4, 0x90
	.type	main,@function
...
# %bb.0:
	...
	movb	$0, %al
	callq	printf@PLT
	callq	FF_function_363
	xorl	%edi, %edi
	callq	CF_function_387
	movq	%rax, -840(%rbp)
	movq	%rdx, -832(%rbp)
	xorps	%xmm0, %xmm0
	xorps	%xmm1, %xmm1
...
# %bb.137:                              #   in Loop: Header=BB80_121 Depth=1
	...
	movb	$0, %al
	callq	printf@PLT
	movl	$2539, -200(%rbp)               # imm = 0x9EB
.LBB80_138:                             #   Parent Loop BB80_121 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	cvtsi2sdl	-200(%rbp), %xmm0
	movsd	.LCPI80_2(%rip), %xmm1          # xmm1 = mem[0],zero
	ucomisd	%xmm0, %xmm1
	jb	.LBB80_141
# %bb.139:                              #   in Loop: Header=BB80_138 Depth=2
...
# %bb.156:                              #   in Loop: Header=BB80_121 Depth=1
	...
	movb	$0, %al
	callq	printf@PLT
	movl	$2707, -20(%rbp)                # imm = 0xA93
.LBB80_157:                             #   Parent Loop BB80_121 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	cvtsi2sdl	-20(%rbp), %xmm0
	movsd	.LCPI80_3(%rip), %xmm1          # xmm1 = mem[0],zero
	ucomisd	%xmm1, %xmm0
	jne	.LBB80_158
	jp	.LBB80_158
	jmp	.LBB80_160
...
# %bb.162:                              #   in Loop: Header=BB80_121 Depth=1
	...
	movb	$0, %al
	callq	printf@PLT
	movss	.LCPI80_4(%rip), %xmm0          # xmm0 = mem[0],zero,zero,zero
	movss	%xmm0, -16(%rbp)
.LBB80_163:                             #   Parent Loop BB80_121 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movss	-16(%rbp), %xmm0                # xmm0 = mem[0],zero,zero,zero
	cvtss2sd	%xmm0, %xmm0
	movsd	.LCPI80_5(%rip), %xmm1          # xmm1 = mem[0],zero
	ucomisd	%xmm1, %xmm0
	jbe	.LBB80_167
# %bb.164:                              #   in Loop: Header=BB80_163 Depth=2
	movss	-16(%rbp), %xmm0                # xmm0 = mem[0],zero,zero,zero
	cvtss2sd	%xmm0, %xmm0
	movabsq	$.L.str.398, %rdi
	movb	$1, %al
	callq	printf@PLT
	callq	getchar@PLT
...
.LBB80_166:                             #   in Loop: Header=BB80_163 Depth=2
	movss	.LCPI80_7(%rip), %xmm0          # xmm0 = mem[0],zero,zero,zero
	addss	-16(%rbp), %xmm0
	movss	%xmm0, -16(%rbp)
	jmp	.LBB80_163
...
.LBB80_194:
	...
	xorps	%xmm0, %xmm0
	movsd	%xmm0, -736(%rbp)
	movabsq	$.L.str.415, %rdi
	movb	$0, %al
	callq	printf@PLT
	movabsq	$.L.str.416, %rdi
	movb	$0, %al
	callq	printf@PLT
	movq	$0, -728(%rbp)
	movb	$0, -96(%rbp)
	...
	callq	FF_function_341
	movb	$0, -80(%rbp)
	movabsq	$.L.str.425, %rdi
	movb	$0, %al
	callq	printf@PLT
	movabsq	$.L.str.426, %rdi
	movb	$0, %al
	callq	printf@PLT
	movabsq	$.L.str.427, %rdi
	movb	$0, %al
	callq	printf@PLT
	movabsq	$.L.str.428, %rdi
	movb	$0, %al
	callq	printf@PLT
	movw	$0, -216(%rbp)
	movq	$0, -720(%rbp)
	movw	$0, -208(%rbp)
	movb	$0, -72(%rbp)
	movabsq	$.L.str.429, %rdi
	movb	$0, %al
	callq	printf@PLT
	movabsq	$.L.str.430, %rdi
	movb	$0, %al
	callq	printf@PLT
	movabsq	$.L.str.431, %rdi
	movb	$0, %al
	callq	printf@PLT
	...
	movb	$0, -64(%rbp)
	movb	$0, -56(%rbp)
	movabsq	$.L.str.435, %rdi
	movb	$0, %al
	callq	printf@PLT
	movabsq	$.L.str.436, %rdi
	movb	$0, %al
	callq	printf@PLT
	movq	$0, -704(%rbp)
	movl	$0, -296(%rbp)
	...
	movb	$0, -48(%rbp)
	xorl	%edi, %edi
	callq	FF_function_361
	xorl	%edi, %edi
	callq	CF_function_392
	movb	%al, -40(%rbp)
	movabsq	$.L.str.438, %rdi
	movb	$0, %al
	callq	printf@PLT
	movl	$0, -36(%rbp)
.LBB80_195:
...
.L__const.FF_function_352.FF_x:
	...
	.long	0x3f000000                      # float 0.5
	.quad	0
	.size	.L__const.FF_function_352.FF_x, 16
...
.L__const.FF_function_350.FF_x:
	...
	.long	0x3f000000                      # float 0.5
	.quad	0
	.size	.L__const.FF_function_350.FF_x, 16
...
.L__const.FF_function_347.FF_x:
	...
	.long	0x3f000000                      # float 0.5
	.quad	0
	.size	.L__const.FF_function_347.FF_x, 16
...
.L__const.FF_function_342.FF_x:
	...
	.long	0x3f000000                      # float 0.5
	.quad	0
	.size	.L__const.FF_function_342.FF_x, 16
...
.L__const.FF_function_339.FF_x:
	...
	.long	0x3f000000                      # float 0.5
	.quad	0
	.size	.L__const.FF_function_339.FF_x, 16
...
.L__const.FF_function_335.FF_x:
	...
	.long	0x3f000000                      # float 0.5
	.quad	0
	.size	.L__const.FF_function_335.FF_x, 16
...
.L__const.FF_function_327.FF_x:
	...
	.long	0x3f000000                      # float 0.5
	.quad	0
	.size	.L__const.FF_function_327.FF_x, 16
...
.L__const.FF_function_323.FF_x:
	...
	.long	0x3f000000                      # float 0.5
	.quad	0
	.size	.L__const.FF_function_323.FF_x, 16
...
.L__const.FF_function_320.FF_x:
	...
	.long	0x3f000000                      # float 0.5
	.quad	0
	.size	.L__const.FF_function_320.FF_x, 16
...
.L__const.FF_function_317.FF_x:
	...
	.long	0x3f000000                      # float 0.5
	.quad	0
	.size	.L__const.FF_function_317.FF_x, 16
