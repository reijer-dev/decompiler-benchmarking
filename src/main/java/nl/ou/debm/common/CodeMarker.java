...
public abstract class CodeMarker {
    ...
    private static final char PROPERTYSEPARATOR =',';
    /** separates property name from property value */
    private static final char VALUESEPARATOR =':';
    /** escape necessary to use the toSting-result as a string in C-code */
    private static final char DOUBLEQUOTES ='\"';
    /** escapes special separator chars */
    private static final char ESCAPECHAR ='\\';
    /** escape characters in proper working order */
    private static final char[] ESCAPESEQUENCE = {ESCAPECHAR, PROPERTYSEPARATOR, VALUESEPARATOR, DOUBLEQUOTES};
    /** special field to be used with printf */
    private static final String STRDECIMALFIELD = "__DECIMAL_FIELD__";
    /** special field to be used with printf */
    private static final String STRFLOATFIELD = "__FLOAT_FIELD__";
    /** field to determine whether the code marker was autogenerated */
    private static final String STRAUTOGEN = "AUTOGENERATED";
    /** checksum for integrity purposes */
    private static final String STRCHECKSUM = "CHECKSUM";
    /** makes sure this is not an ordinary string, but a code marker string */
    public static final String STRCODEMARKERGUID = "c5852db2-7acb-cba3-7f81-e7ef3cd1d3b8";
    /** end marker for header */
    private static final String STRHEADEREND = ">>";
