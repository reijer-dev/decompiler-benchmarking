...
//                System.out.println("Direct hit: " + m_precedingCodeMarkerForLoops.lngGetLoopID() + "----" + strSafeLeftString(ctx.getText(),40));
//                System.out.println();
...
//        System.out.println();
//        System.out.println("Body analysis... " + strSafeLeftString(ctx.getText(),40));
