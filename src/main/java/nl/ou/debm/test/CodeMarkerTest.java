...
//        assertNotNull(cm.getID());  TODO
        ...
        // copy 1
        var cm2 = new BaseCodeMarker(cm.toString());
        // assert values
        for (x=0; x<P.length ; ++x) {
        ...
        // test autogen
        assertFalse(cm3.bGetAutoGeneratedFlag());
        cm3.setAutoGeneratedFlag(false);
        assertFalse(cm3.bGetAutoGeneratedFlag());
        cm3.setAutoGeneratedFlag(true);
        assertTrue(cm3.bGetAutoGeneratedFlag());
        cm3.setAutoGeneratedFlag(false);
        assertFalse(cm3.bGetAutoGeneratedFlag());
    }
    ...
    void IDTests() {
        ...
        var f= new LoopProducer(new CGenerator());
        BaseCodeMarker[] cm = new BaseCodeMarker[10];
        for (int z=0;z<cm.length;++z){cm[z] = new BaseCodeMarker(f);}
        CheckUnique(cm);

        // copy from other object
        cm[0] = new BaseCodeMarker(cm[1]);
        CheckUnique(cm);
